...
class SaleOrder(models.Model):
    ...
    def _onchange_partner_receipts_sale(self):
        self.receipts = self.partner_id.use_sale_receipts

    def _prepare_invoice(self):
        invoice_values = super()._prepare_invoice()
        force_receipts = self.env.context.get("force_receipts")
        is_receipt = self.receipts if force_receipts is None else force_receipts
        if is_receipt:
